...
void swap2Rows(int ar[][SIZE], int r1, int r2)
{
    //We traverse the columns and for each column, we swap the two row's values that are of the same column.
    int col;
    int temp;
    if (r1 >= 0 && r1 < SIZE && r2 < SIZE){ //We implement this to check whether or not r1 and r2 are within the range of the array.
